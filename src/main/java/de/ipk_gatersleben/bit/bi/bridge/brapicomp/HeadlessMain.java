...
public class HeadlessMain {
	private static final Logger LOGGER = LoggerFactory.getLogger(HeadlessMain.class.getName());
	...
	private static CommandLine parseArgs(String[] args) {
		...
		Option token = new Option("t", "token", true,
				"(Default None) Authorization token to be sent with every request.");
		...
		Option strict = new Option("s", "strict", false,
				"If used, the validator will not allow extra fields in response objects.");
